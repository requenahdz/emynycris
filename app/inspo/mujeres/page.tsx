...
import inspoMujeres from "../../assets/images/inspo-mujeres.png";
import rose1 from "../../assets/images/rosa1.png";
import rose2 from "../../assets/images/rosa2.png";

export default function InspoMujeresPage() {
  return (
    <main className="relative min-h-screen w-full overflow-hidden flex items-center justify-center px-4 py-10">
      ...
      <div className="relative z-10 w-full max-w-[1100px]">
        <div className="flex items-center justify-center gap-6">
          <Image src={rose1} alt="" className="w-20 md:w-24 h-auto opacity-70" />
          <h1 className="text-center font-serif text-[40px] md:text-[56px] tracking-[0.16em] text-[#3b3531]">
            INSPO
          </h1>
          <Image src={rose2} alt="" className="w-20 md:w-24 h-auto opacity-70" />
        </div>
        ...
        <Image src={inspoMujeres} alt="Inspiración mujeres" className="w-full h-auto" priority />
      </div>
    </main>
  );
}
